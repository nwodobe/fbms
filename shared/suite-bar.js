...
(function () {
  ...
  var CSS = [
    ...
    '#anagroci-suite-bar a{text-decoration:none!important}',
    ...
    '#anagroci-suite-menu a{display:flex;gap:10px;align-items:center;padding:9px 10px;border-radius:10px;text-decoration:none!important}',
    '#anagroci-suite-menu a b,#anagroci-suite-menu a span{text-decoration:none!important}',

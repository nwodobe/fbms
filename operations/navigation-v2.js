...
var defs={
 field:{title:'FIELD BUYING',routes:[['overview','Vue d’ensemble'],['purchases','Achat Bord Champ'],['census','Recensement'],['farmers','Producteurs'],['rt','RT & Villages'],['hubs','Hubs & Cartographie'],['bags','Sacherie AFLP'],['cash','Caisse & Avances'],['command','Command Center'],['sustainability','Sustainability'],['traceability','Traceability'],['aflp-data','AFLP DATA','aflp-data.html']]},
 ...
 trace:{title:'TRACEABILITY 360',routes:[]},reports:{title:'REPORTS & EXPORT',routes:[['activity-report','Rapports d’activité','activity-report.html'],['aflp-data','AFLP DATA','aflp-data.html'],['consolidated','Export consolidé','reports.html'],['warehouse','Warehouse','warehouse.html'],['procurement','Procurement','procurement.html']]}
};

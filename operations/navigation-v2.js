...
var defs={
 ...
 lba:{title:'LBA PURCHASE',routes:[['overview','Overview'],['registry','LBA Registry'],['limits','Funding Limits'],['financing','Financing'],['cycles','Funding Cycles'],['deliveries','RCN Deliveries'],['bags','Bag Management'],['balances','Balances'],['aging','Aging & Alerts'],['performance','Performance'],['documents','Documents'],['audit','Audit']]},

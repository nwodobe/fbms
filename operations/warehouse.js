...
function nextStepText(r){var a=nextActionForReception(r);if(r.status==='RELEASED'&&a.label==='Consulter le LOT')return'Aucune (LOT stocké en BIN)';if(a.label==='Consulter le dossier')return'-';return a.label;}

...
global.RCNProcControl={load:load,ensure:ensure,data:function(){return data;},rows:rows,role:role,control:control,volume:volume,checkPrice:checkPrice,saveSettings:saveSettings,saveControl:saveControl,addMarket:addMarket,createOrder:createOrder,updateOrder:updateOrder,addPayment:addPayment,reconcilePayment:reconcilePayment,allocate:allocate,stats:stats};
})(window);
